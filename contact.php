...
if(isset($_REQUEST['submit'])) {
    ...
    $sub = "KathakaliSchool.com General enquiry from"." ".$name;
    $msg = $descr;
    ...
    <section class="main-content" id="content">
        ...
        <header class="content-header">
            ...
            <div class="content-header-body">
                <p>
                    Please use the form below to get in touch with us for any type of enquiries.
                </p>
                <div class="content-header-lnk-group">
                    <a href="./training.html" class="icon-info">Join a course.</a>
                    <a href="./book.php" class="icon-msg">Book an Event.</a>
                </div>
            </div>
        </header>

        <form name="form1" method="post" action="" class="training-form">
